...
export function Video(props: VideoPros) {
          ...
          <div className="flex-1 ">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <div className="leading-relaxed">
                <strong className="font-blod text-2xl block">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Material complemtar</strong>
              <p className="text-sm text-gray-200 mt-w">
